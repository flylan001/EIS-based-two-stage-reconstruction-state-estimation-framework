...
%% 降采样频率设置为 100Hz
Fn = 100;
[XTrain,YTrain,XVal,YVal,XTest,YTest,N_EIS,eis_mean_std] = lstm_data_set_no_onehot_half(100,1:51);
...
% 降采样频率设置为 50Hz
Fn = 50;
[XTrain,YTrain,XVal,YVal,XTest,YTest,N_EIS,eis_mean_std] = lstm_data_set_no_onehot_half(100,11:41);
[layers,options] = lstm_model_set(2,128,2*N_EIS,XVal,YVal);
gpuDevice(1)
[net, trainInfo] = trainNetwork(XTrain,YTrain,layers,options);
save(['lstm_ui2eis_battery_half_',num2str(Fn),'.mat'], 'net', 'trainInfo' );
