...
%% ===================== 降采样频率设置为 100Hz =====================
Fn = 100;
[XTrain1,YTrain1,XVal1,YVal1,XTest1,YTest1,N_EIS1,eis_mean_std1] = lstm_data_set_onehot(Fn,1);
[XTrain3,YTrain3,XVal3,YVal3,XTest3,YTest3,N_EIS3,eis_mean_std3] = lstm_data_set_onehot(Fn,3);
