...
save SVRMdl1_battery3_SOC.mat SVRMdl1
%%
...
save_path=strcat('SVR_figure','\','LFP3 Temp SOC SVR 1');
...
SVRMdl2 = fitrsvm(X, Y,  'KernelFunction', 'RBF','OptimizeHyperparameters','auto',...
    'HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'), ...
    'Verbose', 0);
save SVRMdl2_battery3_SOC.mat SVRMdl2
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('SVR_figure','\','LFP3 Temp SOC SVR 2');
print(gcf, save_path,'-dsvg','-r1200');
...
SVRMdl3 = fitrsvm(X, Y,  'KernelFunction', 'RBF','OptimizeHyperparameters','auto',...
    'HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'), ...
    'Verbose', 0);
save SVRMdl3_battery3_SOC.mat SVRMdl3
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('SVR_figure','\','LFP3 Temp SOC SVR 3');
print(gcf, save_path,'-dsvg','-r1200');
...
SVRMdl4 = fitrsvm(X, Y,  'KernelFunction', 'RBF','OptimizeHyperparameters','auto',...
    'HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'), ...
    'Verbose', 0);
save SVRMdl4_battery3_SOC.mat SVRMdl4
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('SVR_figure','\','LFP3 Temp SOC SVR 4');
print(gcf, save_path,'-dsvg','-r1200');
...
SVRMdl5 = fitrsvm(X, Y,  'KernelFunction', 'RBF','OptimizeHyperparameters','auto',...
    'HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'), ...
    'Verbose', 0);
save SVRMdl5_battery3_SOC.mat SVRMdl5
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('SVR_figure','\','LFP3 Temp SOC SVR 5');
print(gcf, save_path,'-dsvg','-r1200');

RMSE_test3(5) = rmse(Y,ypre_all);


save battery3_SVR_SOC.mat
save std_mean_battry3_SOC.mat SVR_mean SVR_std