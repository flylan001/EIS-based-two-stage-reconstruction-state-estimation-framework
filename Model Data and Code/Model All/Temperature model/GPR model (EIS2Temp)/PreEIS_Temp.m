...
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 1 1']);
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 1 2']);
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 1 3']);
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 1 4']);
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 1 5']);
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 3 1']);
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 3 2']);
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 3 3']);
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 3 4']);
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Times New Roman');
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS for Temp 100Hz 3 5']);
print(gcf, save_path,'-dsvg','-r1200');
...
load ../GPR_EIS-SOC2Temp/RMSE_SOC.mat
for i = 1:1:5
...
leg=legend('GPR model for cell-1','GPR model for cell-2','GPR model with SOC for cell-1','GPR model with SOC for cell-2');
...
axis([0.2 5.8 0 2.9])
gca=boxoff(gca);clear gca
save_path=strcat(['GPR_figure','\','Pre EIS + SOC for Temp 100Hz RMSE']);
print(gcf, save_path,'-dsvg','-r1200');