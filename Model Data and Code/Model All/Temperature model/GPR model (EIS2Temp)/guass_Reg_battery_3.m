...
save_path=strcat('GPR_figure','\','LFP3 Temp Guass 1');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass w 1');
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass 2');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass w 2');
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass 3');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass w 3');
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass 4');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass w 4');
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass 5');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass w 5');
print(gcf, save_path,'-dsvg','-r1200');
