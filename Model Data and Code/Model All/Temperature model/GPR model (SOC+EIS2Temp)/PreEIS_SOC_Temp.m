...
axis equal;
axis([17 49 17 49])
xlabel("Measured Temperature");ylabel('Predicted Temperature');

set(gca,'LineWidth',3,'position',[0.15,0.15,0.8,0.8]);
set(gca,'xtick',-100:50:1000,'ytick',-100:50:200,'FontSize',48,'LabelFontSizeMultiplier',1,'FontName','Arial');
