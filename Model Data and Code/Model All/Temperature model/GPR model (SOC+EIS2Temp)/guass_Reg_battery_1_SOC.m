...
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC 1');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC w 1');
print(gcf, save_path,'-dsvg','-r1200');
...
%% 前2
index0 = 1:1300;
X = [real0(index0(:),11:21),imag0(index0(:),11:21),soc(index0(:))'];
Y = T(index0(:));
%%
gprMdl2 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl2_battery1_SOC.mat gprMdl2
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC 2');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC w 2');
print(gcf, save_path,'-dsvg','-r1200');
...
%% 前3
index0 = 1:1300;
X = [real0(index0(:),21:31),imag0(index0(:),21:31),soc(index0(:))'];
Y = T(index0(:));
...
gprMdl3 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl3_battery1_SOC.mat gprMdl3
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC 3');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC w 3');
print(gcf, save_path,'-dsvg','-r1200');
...
%% 前4
index0 = 1:1300;
X = [real0(index0(:),31:41),imag0(index0(:),31:41),soc(index0(:))'];
Y = T(index0(:));
...
gprMdl4 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl4_battery1_SOC.mat gprMdl4
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC 4');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC w 4');
print(gcf, save_path,'-dsvg','-r1200');
...
%% 前5
index0 = 1:1300;
X = [real0(index0(:),41:51),imag0(index0(:),41:51),soc(index0(:))'];
Y = T(index0(:));
...
gprMdl5 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl5_battery1_SOC.mat gprMdl5
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC 5');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 Temp Guass SOC w 5');
print(gcf, save_path,'-dsvg','-r1200');

RMSE_test1(5) = rmse(Y,ypre_all);


save battery1_SOC_Guass.mat