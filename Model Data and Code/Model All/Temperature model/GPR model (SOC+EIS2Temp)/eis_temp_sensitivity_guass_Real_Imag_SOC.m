...
save_path=strcat('GPR_figure','\','LFP1 eis SOC temp senseitivity Real and Imag 1');
...
xlabel('Additional Noise of EIS (μΩ)'); ylabel('RMSE of Temperature (\circC)');  ytickformat('%.1f')
set (gca,'LineWidth',3,'position',[0.18,0.18,0.8,0.8]);
set(gca,'xtick',-100:1:1000,'ytick',-0:0.5:8,'FontSize',32,'LabelFontSizeMultiplier',1.2,'FontName','Arial');
leg=legend(plo_all,leg);
set(leg,'Location','Northwest','FontSize',24,'FontName','Arial','Orientation','v','NumColumns',2,'box','off');
leg.ItemTokenSize=[45,18];  %
axis([-0.5 5.5 -0.1 2.49])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 eis SOC temp senseitivity Real and Imag 2');
print(gcf, save_path,'-dsvg','-r1200');
...
axis([-0.5 5.5 -0.1 2.49])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 eis SOC temp senseitivity Real and Imag 3');
print(gcf, save_path,'-dsvg','-r1200');
...
plo = plot([-10,-9],[-10,-9],'-k','LineWidth',3,'MarkerSize',12);hold on;plo_all = [plo_all,plo];
plo = plot([-10,-9],[-10,-9],'-.k','LineWidth',3,'MarkerSize',12);plo_all = [plo_all,plo];
plo = plot([-10,-9],[-10,-9],'-w','LineWidth',3,'MarkerSize',12);
leg{1} = ["Z'"];
leg{2} = ['Z"'];
for i=1:1:length(temp)
    index1 = [1:100] + (i-1) * 100 ;
...
RMSE_R_I.battery1_SOC.RMSE3 = RMSE_mean1;
xlabel('Noise of EIS (μΩ)'); ylabel('RMSE of Temperature');  ytickformat('%.0f')
set (gca,'LineWidth',3,'position',[0.20,0.21,0.75,0.77]);
set(gca,'xtick',-100:1:1000,'ytick',-0:1:8,'FontSize',48,'LabelFontSizeMultiplier',1,'FontName','Arial');
leg=legend(plo_all,leg);
set(leg,'Location','Northwest','FontSize',36,'FontName','Arial','Orientation','v','NumColumns',1,'box','off');
leg.ItemTokenSize=[45,18];  %
axis([-0.5 5.5 -0.1 2.49])
set(gcf, 'Color', 'none');     % figure 透明
set(gca, 'Color', 'none');     % 坐标轴背景透明（可选）
...
axis([-0.5 5.5 -0.1 2.49])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 eis SOC temp senseitivity Real and Imag 4');
print(gcf, save_path,'-dsvg','-r1200');
...
axis([-0.5 5.5 -0.1 2.49])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 eis SOC temp senseitivity Real and Imag 5');
print(gcf, save_path,'-dsvg','-r1200');
...
axis([-0.5 5.5 -0.1 6.5])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 eis SOC temp senseitivity Real and Imag 1');
print(gcf, save_path,'-dsvg','-r1200');
...
axis([-0.5 5.5 -0.1 2.49])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 eis SOC temp senseitivity Real and Imag 2');
print(gcf, save_path,'-dsvg','-r1200');
...
axis([-0.5 5.5 -0.1 2.49])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 eis SOC temp senseitivity Real and Imag 3');
print(gcf, save_path,'-dsvg','-r1200');
...
axis([-0.5 5.5 -0.1 2.49])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 eis SOC temp senseitivity Real and Imag 4');
print(gcf, save_path,'-dsvg','-r1200');
...
axis([-0.5 5.5 -0.1 2.49])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 eis SOC temp senseitivity Real and Imag 5');
print(gcf, save_path,'-dsvg','-r1200');
...
for i =1:1:5
    RMSE_Gpr = RMSE_R_I.battery1_SOC.(['RMSE',num2str(i)]);
    for j = 1:1:13*2
        x = sigma(3:end)*1e6;
        y = RMSE_Gpr(3:end,j);
        p = polyfit(x, y, 1);
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP1 eis SOC temp senseitivity freq Real and Imag');
print(gcf, save_path,'-dsvg','-r1200');
...
axis([20 46 -0.05 1.99])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 eis SOC temp senseitivity freq Real and Imag');
print(gcf, save_path,'-dsvg','-r1200');
...
for i=1:1:length(temp)
    ...
    X = [real0(index1,1:11),imag0(index1,1:11),soc(index1)'];Y = T(index1);
    load gprMdl1_battery1_SOC.mat
    [sigma,RMSE_mean_SOC(:,i)] = GPR_Monte_Carlo_SOC(gprMdl1,X,Y);
...
axis([-2 22 -0.1 2.4])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP eis SOC temp senseitivity freq SOC 1');
print(gcf, save_path,'-dsvg','-r1200');
...
for i=1:1:length(temp)
    ...
    X = [real0(index1,11:21),imag0(index1,11:21),soc(index1)'];Y = T(index1);
    load gprMdl2_battery1_SOC.mat
    [sigma,RMSE_mean_SOC(:,i)] = GPR_Monte_Carlo_SOC(gprMdl2,X,Y);
    plo = plot(sigma* 100,RMSE_mean_SOC(:,i),'-','Color',color(i,:),'LineWidth',3,'MarkerSize',12);hold on
    plo_all = [plo_all,plo];
    leg{i+3} = [num2str(temp(i)),' \circC '];
end
...
axis([-2 22 -0.1 1.4])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP eis SOC temp senseitivity freq SOC 2');
print(gcf, save_path,'-dsvg','-r1200');
...
for i=1:1:length(temp)
    ...
    X = [real0(index1,21:31),imag0(index1,21:31),soc(index1)'];Y = T(index1);
    load gprMdl3_battery1_SOC.mat
    [sigma,RMSE_mean_SOC(:,i)] = GPR_Monte_Carlo_SOC(gprMdl3,X,Y);
    plo = plot(sigma* 100,RMSE_mean_SOC(:,i),'-','Color',color(i,:),'LineWidth',3,'MarkerSize',12);hold on
    plo_all = [plo_all,plo];
    leg{i+3} = [num2str(temp(i)),' \circC '];
end
...
axis([-2 22 -0.1 1.4])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP eis SOC temp senseitivity freq SOC 3');
print(gcf, save_path,'-dsvg','-r1200');
...
xlabel('Noise of SOC (%)'); ylabel('RMSE of Temperature'); ytickformat('%.0f');
set (gca,'LineWidth',3,'position',[0.20,0.21,0.75,0.77]);
set(gca,'xtick',-100:5:1000,'ytick',-0:1:8,'FontSize',48,'LabelFontSizeMultiplier',1,'FontName','Arial');
leg=legend(plo_all,leg);
set(leg,'Location','Northwest','FontSize',36,'FontName','Arial','Orientation','v','NumColumns',1,'box','off');
leg.ItemTokenSize=[45,18];  %
axis([-2 22 -0.1 1.4])
...
for i=1:1:length(temp)
    ...
    X = [real0(index1,31:41),imag0(index1,31:41),soc(index1)'];Y = T(index1);
    load gprMdl4_battery1_SOC.mat
    [sigma,RMSE_mean_SOC(:,i)] = GPR_Monte_Carlo_SOC(gprMdl4,X,Y);
    plo = plot(sigma* 100,RMSE_mean_SOC(:,i),'-','Color',color(i,:),'LineWidth',3,'MarkerSize',12);hold on
    plo_all = [plo_all,plo];
    leg{i+3} = [num2str(temp(i)),' \circC '];
end
...
axis([-2 22 -0.1 1.4])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP eis SOC temp senseitivity freq SOC 4');
print(gcf, save_path,'-dsvg','-r1200');
...
for i=1:1:length(temp)
    ...
    X = [real0(index1,41:51),imag0(index1,41:51),soc(index1)'];Y = T(index1);
    load gprMdl5_battery1_SOC.mat
    [sigma,RMSE_mean_SOC(:,i)] = GPR_Monte_Carlo_SOC(gprMdl5,X,Y);
    plo = plot(sigma* 100,RMSE_mean_SOC(:,i),'-','Color',color(i,:),'LineWidth',3,'MarkerSize',12);hold on
    plo_all = [plo_all,plo];
    leg{i+3} = [num2str(temp(i)),' \circC '];
end
...
axis([-2 22 -0.1 1.4])
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP eis SOC temp senseitivity freq SOC 5');
print(gcf, save_path,'-dsvg','-r1200');
...
color = flipud(colorInterp_lan(6, 6));color(1,:)=[];temp = 21:2:45;
for i =1:1:5
    RMSE_Gpr = RMSE_R_I_SOC.battery1.(['RMSE',num2str(i)]);
    for j = 1:1:13
        x = sigma(3:end)*10;
        y = RMSE_Gpr(3:end,j);
        p = polyfit(x, y, 1);
...
for i =1:1:5
    RMSE_Gpr = RMSE_R_I_SOC.battery3.(['RMSE',num2str(i)]);
    for j = 1:1:13
        x = sigma(3:end)*10;
        y = RMSE_Gpr(3:end,j);
        p = polyfit(x, y, 1);
...
xlabel('Temperature (\circC)');
ylabel('d\rmT/d\rm(10%SOC) (\circC)');ytickformat('%.1f')
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP eis SOC temp senseitivity freq Real and Imag');
print(gcf, save_path,'-dsvg','-r1200');
...
%%% 蒙特卡洛算法 
function [sigma,RMSE_mean] = GPR_Monte_Carlo_SOC(gprMdl,X,Y)
NumC = 50;
RMSE_test =zeros(10,NumC);
% 添加噪声 0 sigma1 sigma2 sigma3 sigma4
sigma = [0:1:10]*0.02;
