...
save gprMdl1_battery3_SOC.mat gprMdl1
%%
...
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC 1');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC w 1');
print(gcf, save_path,'-dsvg','-r1200');
...
gprMdl2 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl2_battery3_SOC.mat gprMdl2
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC 2');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC w 2');
print(gcf, save_path,'-dsvg','-r1200');
...
gprMdl3 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl3_battery3_SOC.mat gprMdl3
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC 3');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC w 3');
print(gcf, save_path,'-dsvg','-r1200');
...
gprMdl4 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl4_battery3_SOC.mat gprMdl4
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC 4');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC w 4');
print(gcf, save_path,'-dsvg','-r1200');
...
gprMdl5 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl5_battery3_SOC.mat gprMdl5
%%
...
set(gca,'xtick',-100:5:1000,'ytick',-100:5:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC 5');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 Temp Guass SOC w 5');
print(gcf, save_path,'-dsvg','-r1200');

RMSE_test3(5) = rmse(Y,ypre_all);


save battery3_SOC_Guass.mat