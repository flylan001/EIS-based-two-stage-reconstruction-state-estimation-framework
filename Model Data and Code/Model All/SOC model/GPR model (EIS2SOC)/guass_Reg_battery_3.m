...
save gprMdl1_battery3.mat gprMdl1
%%
...
save_path=strcat('GPR_figure','\','LFP3 SOC Guass 1');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass w 1');
print(gcf, save_path,'-dsvg','-r1200');

RMSE_test3(1) = rmse(Y*100,ypre_all*100);
...
gprMdl2 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl2_battery3.mat gprMdl2
%%
...
set(gca,'xtick',-100:25:1000,'ytick',-100:25:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass 2');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass w 2');
print(gcf, save_path,'-dsvg','-r1200');

RMSE_test3(2) = rmse(Y*100,ypre_all*100);
...
gprMdl3 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl3_battery3.mat gprMdl3
%%
...
set(gca,'xtick',-100:25:1000,'ytick',-100:25:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass 3');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass w 3');
print(gcf, save_path,'-dsvg','-r1200');

RMSE_test3(3) = rmse(Y*100,ypre_all*100);
...
gprMdl4 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl4_battery3.mat gprMdl4
%%
...
set(gca,'xtick',-100:25:1000,'ytick',-100:25:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass 4');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass w 4');
print(gcf, save_path,'-dsvg','-r1200');

RMSE_test3(4) = rmse(Y*100,ypre_all*100);
...
gprMdl5 = fitrgp(X,Y,'KernelFunction','ardsquaredexponential','Verbose',1, ...
    'Optimizer','lbfgs', ...
    'Sigma',0.1,'InitialStepSize',1);
save gprMdl5_battery3.mat gprMdl5
%%
...
set(gca,'xtick',-100:25:1000,'ytick',-100:25:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass 5');
print(gcf, save_path,'-dsvg','-r1200');
...
gca=boxoff(gca);clear gca
save_path=strcat('GPR_figure','\','LFP3 SOC Guass w 5');
print(gcf, save_path,'-dsvg','-r1200');

RMSE_test3(5) = rmse(Y*100,ypre_all*100);

save battery3_guass.mat