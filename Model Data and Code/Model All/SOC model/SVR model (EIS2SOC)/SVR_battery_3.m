...
save_path=strcat('SVR_figure','\','LFP3 SOC SVR 1');
...
set(gca,'xtick',-100:25:1000,'ytick',-100:25:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('SVR_figure','\','LFP3 SOC SVR 2');
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:25:1000,'ytick',-100:25:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('SVR_figure','\','LFP3 SOC SVR 3');
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:25:1000,'ytick',-100:25:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('SVR_figure','\','LFP3 SOC SVR 4');
print(gcf, save_path,'-dsvg','-r1200');
...
set(gca,'xtick',-100:25:1000,'ytick',-100:25:200,'FontSize',24,'LabelFontSizeMultiplier',1,'FontName','Arial');
gca=boxoff(gca);clear gca
save_path=strcat('SVR_figure','\','LFP3 SOC SVR 5');
print(gcf, save_path,'-dsvg','-r1200');
